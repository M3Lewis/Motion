...
namespace Motion.Export
{
    ...
    internal static class FFmpegUtil
    {
        ...
        private static string InstallFolder => Path.Combine(MotionInfo.WorkingFolder, "ffmpeg");
        private static string DownloadFileName => Path.Combine(MotionInfo.WorkingFolder, "ffmpeg-installer.zip");
