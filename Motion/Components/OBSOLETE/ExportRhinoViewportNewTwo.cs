...
{
    public class ExportRhinoViewportNewTwo : GH_Component
    {
        protected override System.Drawing.Bitmap Icon => null;
        public override GH_Exposure Exposure => GH_Exposure.hidden;
        public override Guid ComponentGuid => new Guid("628df1e6-81ad-41aa-bfb6-af0a2dedbac6");
        public ExportRhinoViewportNewTwo()
          : base("ExportRhinoViewportNewTwo", "ExportRhinoViewportNewTwo",
            "导出Rhino视窗图片，支持透明度",
            "Motion", "02_Export")
        {
        }
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            {
                while (sliderValue <= maxValue && iRun == true)
                {
                    ExportSliderViewports(iRun, unionSlider, iWidth, iHeight, sliderValue, iFullPath, out oPath);
                }
