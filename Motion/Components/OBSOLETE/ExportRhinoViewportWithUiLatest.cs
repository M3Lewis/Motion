...
{
    public class ExportRhinoViewportWithUiComponent : GH_Component
    {
        protected override Bitmap Icon => null;
        public override GH_Exposure Exposure => GH_Exposure.hidden;
        public override Guid ComponentGuid => new Guid("77B99E56-A02D-4B44-ACF1-F103E0293F7C");

        public ExportRhinoViewportWithUiComponent()
          : base("ExportRhinoViewportWithUi", "ExportRhinoViewportWithUi",
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            if (unionSliderObjectTypeName != "pOd_TimeLineSlider") return;

            GH_NumberSlider unionSlider = (GH_NumberSlider)unionSliderObject;
            MotionSliderAnimatorWithUi sliderAnimator = new MotionSliderAnimatorWithUi(unionSlider);
