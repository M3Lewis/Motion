...
namespace Motion.Animation
{
    public class SliderInterval : GH_Component
    {
        ...
        public SliderInterval()
            : base("SliderInterval", "SliderInterval", "��ȡSlider������", "Motion", "01_Animation")
        { }
        ...
        {
            pManager.AddNumberParameter("Output Data", "O", "�������", GH_ParamAccess.item);
            pManager.AddIntervalParameter("Range", "R", "Slider����", GH_ParamAccess.item);
        }

        public override void AddedToDocument(GH_Document document) //�Զ�����
        {
